...
public class JavaTypeParserTest {
    ...
    void canThrowErrorsOrReturnNullWhenInvalidLineIsParsed() {
        ...
        var examples = List.of(
                ...
                new Example("public class ", "expected type bound but reached end of line at index 13 (start=13): 'public class '"),
                new Example("class Foo extends ", "expected type bound but reached end of line at index 18 (start=18): 'class Foo extends '"),
                new Example("class Foo implements ", "expected type bound but reached end of line at index 21 (start=21): 'class Foo implements '"),
